...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2016/11/08 17:56:59 by jjia              #+#    #+#              #
#    Updated: 2016/11/20 19:18:44 by jjia             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CFILES = ft_atoi.c  ft_bzero.c ft_isalnum.c ft_isalpha.c \
		 ...
		 ft_digit_length.c ft_isspace.c ft_absolutevalue.c ft_count_words.c \
		ft_power.c ft_strndup.c
CC = gcc
